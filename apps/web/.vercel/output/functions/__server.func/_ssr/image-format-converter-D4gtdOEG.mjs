...
import { o as IconCloudUpload, l as IconDownload, s as IconCircleX, t as IconBox, q as IconLock, u as IconArrowsExchange } from "../_chunks/_libs/@tabler/icons-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-6xl flex-1 flex flex-col items-center justify-center mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-bold text-gray-100 mb-2", children: [
          "Image ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-200", children: "Format" }),
          " Converter"
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-800 rounded-xl shadow-lg p-4 sm:p-8 mb-6 w-full max-w-5xl", children: conversions.length === 0 ? /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onDragOver: handleDragOver, onDragLeave: handleDragLeave, onDrop: handleDrop, className: `border-3 border-dashed rounded-lg p-12 text-center transition-all duration-300 ${isDragging ? "border-amber-500 bg-amber-900/20" : "border-gray-600 hover:border-amber-400 hover:bg-gray-700"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => uploadRef.current?.click(), className: "text-sm px-3 py-2 bg-amber-700 text-amber-100 rounded-lg hover:bg-amber-600 transition-colors duration-200 font-medium shadow-md hover:shadow-lg", children: "Choose Files" })
          ] })
        ] }) }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mb-6", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("select", { value: selectedFormat, onChange: (e) => setSelectedFormat(e.target.value), className: "px-3 py-2 border border-gray-600 rounded-lg bg-gray-700 text-gray-100 focus:outline-none focus:ring-2 focus:ring-amber-500", children: supportedFormats.map((format) => /* @__PURE__ */ jsxRuntimeExports.jsx("option", { value: format.value, className: "bg-gray-700", children: format.label }, format.value)) })
          ] })
        ] }),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-3", children: conversions.map((item) => /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between p-4 border border-gray-600 rounded-lg bg-gray-700", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3 ml-4", children: [
            ...
            item.status === "converting" && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-2", children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-200 text-sm", children: "Converting..." })
            ] }),
