...
import { g as IconBraces, i as IconArrowsMinimize, j as IconCheck, k as IconCopy, l as IconDownload, m as IconTrash, n as IconAlertCircle } from "../_chunks/_libs/@tabler/icons-react.mjs";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "min-h-screen bg-gradient-to-br from-gray-800 to-slate-900 pt-24 pb-8 px-4 flex flex-col", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-bold text-gray-100 mb-2", children: [
        "JSON ",
        /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-200", children: "Formatter" })
      ] }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex-1 max-w-9xl w-full mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "bg-gray-800 rounded-xl shadow-lg p-4 mb-6", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap gap-3 justify-center", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-2 px-4 py-2 bg-gray-700 text-gray-100 rounded-lg", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setUseSingleQuotes(false), className: `px-2 py-1 text-xs rounded transition-colors ${!useSingleQuotes ? "bg-amber-700 text-amber-100" : "bg-gray-600 text-gray-300 hover:bg-gray-500"}`, children: '"' }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setUseSingleQuotes(true), className: `px-2 py-1 text-xs rounded transition-colors ${useSingleQuotes ? "bg-amber-700 text-amber-100" : "bg-gray-600 text-gray-300 hover:bg-gray-500"}`, children: "'" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: formatInput, disabled: !input.trim() || !!error, className: "inline-flex items-center gap-2 px-4 py-2 bg-amber-700 text-amber-100 rounded-lg hover:bg-amber-600 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(IconBraces, { className: "w-4 h-4" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { children: "Format" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("button", { onClick: minifyInput, disabled: !input.trim() || !!error, className: "inline-flex items-center gap-2 px-4 py-2 bg-amber-700 text-amber-100 rounded-lg hover:bg-amber-600 transition-colors duration-200 font-medium disabled:opacity-50 disabled:cursor-not-allowed", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-800 rounded-xl shadow-lg p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center justify-between mb-4", children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-2", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveView("formatted"), className: `px-3 py-1 text-sm rounded-lg transition-colors ${activeView === "formatted" ? "bg-amber-700 text-amber-100" : "bg-gray-700 text-gray-300 hover:bg-gray-600"}`, children: "Formatted" }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => setActiveView("minified"), className: `px-3 py-1 text-sm rounded-lg transition-colors ${activeView === "minified" ? "bg-amber-700 text-amber-100" : "bg-gray-700 text-gray-300 hover:bg-gray-600"}`, children: "Minified" })
            ] })
          ] }),
