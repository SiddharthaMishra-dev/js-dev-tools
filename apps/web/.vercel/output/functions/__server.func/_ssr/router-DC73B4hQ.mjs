...
const appCss = "/assets/styles-DNfTfHzq.css";
...
const $$splitComponentImporter$9 = () => import("./word-counter-CP4IE2vc.mjs");
...
const $$splitComponentImporter$8 = () => import("./tools-DLYJ_hkt.mjs");
...
const $$splitComponentImporter$3 = () => import("./image-cropper-Cced2wSG.mjs");
...
const $$splitComponentImporter$1 = () => import("./csv-xlsx-converter-P3yigNIX.mjs");
...
const $$splitComponentImporter = () => import("./index-BrzQi3ON.mjs");
const Route = createFileRoute("/")({
  head: () => getSeoMetadata({
    title: "JS DevTools | Privacy-first online tools for everyone",
    description: "All-in-one, privacy-first tools for images and data. Convert, compress, crop, format JSON, and more—100% client-side with zero uploads.",
    keywords: ["online tools", "image to base64", "image compressor", "image converter", "json formatter", "csv to xlsx", "privacy-first tools", "client-side utilities"],
    url: "/"
  }),
