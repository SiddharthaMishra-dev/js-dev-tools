...
import { o as IconCloudUpload, j as IconCheck, k as IconCopy, q as IconLock, e as IconBolt, r as IconFileCode } from "../_chunks/_libs/@tabler/icons-react.mjs";
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-5xl flex-1 flex flex-col items-center justify-center mx-auto", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-center mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("h1", { className: "text-2xl font-bold text-gray-100 mb-2", children: [
          "Image to ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-amber-200", children: "Base64" }),
          " Converter"
        ] }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-800 rounded-xl shadow-lg p-8 mb-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { onDragOver: handleDragOver, onDragLeave: handleDragLeave, onDrop: handleDrop, className: `border-3 border-dashed rounded-lg p-12 text-center transition-all duration-300 ${isDragging ? "border-amber-500 bg-amber-900/20" : "border-gray-600 hover:border-amber-400 hover:bg-gray-700"}`, children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-center space-y-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: () => imageRef.current?.click(), className: "text-sm px-3 py-2 bg-amber-700 text-amber-100 rounded-lg hover:bg-amber-600 transition-colors duration-200 font-medium shadow-md hover:shadow-lg", children: "Select Image" })
          ] })
        ] }) }),
      ...
      base64Result && /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-800 w-full max-w-4xl rounded-xl shadow-lg p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex justify-between items-center mb-4", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("button", { onClick: copyToClipboard, className: `px-4 py-2 rounded-lg font-medium transition-all duration-200 ${copySuccess ? "bg-green-800 text-green-200" : "bg-amber-700 text-amber-100 hover:bg-amber-600 shadow-md hover:shadow-lg"}`, children: copySuccess ? /* @__PURE__ */ jsxRuntimeExports.jsxs("span", { className: "flex items-center space-x-2", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("textarea", { value: base64Result, readOnly: true, rows: 8, className: "w-full p-4 border border-gray-600 rounded-lg bg-gray-700 text-gray-100 font-mono text-sm resize-none focus:outline-none focus:ring-2 focus:ring-amber-500", placeholder: "Base64 data will appear here..." }),
