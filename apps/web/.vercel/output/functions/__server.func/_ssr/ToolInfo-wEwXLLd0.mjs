...
import { q as IconLock } from "../_chunks/_libs/@tabler/icons-react.mjs";
function ToolInfo({
  title,
  description,
  features,
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "w-full max-w-5xl mx-auto mt-20 space-y-16 pb-16", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "grid grid-cols-1 md:grid-cols-3 gap-8", children: features.map((feature, index) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-12 h-12 bg-amber-700/20 rounded-lg flex items-center justify-center mb-4 group-hover:bg-amber-700/30 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(feature.icon, { className: "text-amber-400 w-6 h-6" }) }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "bg-gray-800/30 border border-gray-700/50 rounded-2xl p-8 md:p-12", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center space-x-3 mb-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-10 h-10 bg-amber-700 rounded-full flex items-center justify-center text-amber-100 font-bold", children: "?" }),
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col md:flex-row items-center justify-between gap-8 p-8 bg-amber-900/10 border border-amber-900/20 rounded-2xl", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start space-x-4", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-1", children: /* @__PURE__ */ jsxRuntimeExports.jsx(IconLock, { className: "text-amber-500 w-8 h-8" }) }),
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex-shrink-0", children: /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "px-6 py-3 bg-amber-700/20 text-amber-400 rounded-full text-sm font-semibold border border-amber-700/30", children: "Privacy Guaranteed" }) })
    ] })
  ] });
}
export {
